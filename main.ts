function pause_log () {
    if (calibrated == 1) {
        ...
        basic.showString("up")
        basic.showNumber((pitch_var - down_time) / data_count)
        basic.showString("right")
        basic.showNumber(roll_right / data_count)
        basic.showString("left")
        basic.showNumber(roll_left / data_count)
        pause2 = 0
    }
}
...
loops.everyInterval(500, function () {
    if (calibrated == 1 && pause2 == 0) {
        ...
        datalogger.log(
        datalogger.createCV("rot_pit", c_pitch),
        datalogger.createCV("rot_roll", c_roll)
        )
